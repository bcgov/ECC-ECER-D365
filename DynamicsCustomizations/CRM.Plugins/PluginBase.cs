...
namespace CRM.Plugins
{
    ...
    public interface ILocalPluginContext
    {
        ...
        IOrganizationService OrganizationServiceAdmin { get; }
    ...
    public class LocalPluginContext : ILocalPluginContext
    {
        ...
        public IOrganizationService OrganizationServiceAdmin { get; }
        ...
        public LocalPluginContext(IServiceProvider serviceProvider)
        {
            ...
            OrganizationService = serviceProvider.GetOrganizationService(PluginExecutionContext.UserId); // User that the plugin is registered to run as, Could be same as current user.

            OrganizationServiceAdmin = OrgSvcFactory.CreateOrganizationService(null); // User that the plugin is registered to run as, Could be same as current user.
