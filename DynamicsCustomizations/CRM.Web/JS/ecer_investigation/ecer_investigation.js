...
ECER.Jscripts.Investigation =
{
    ...
    onChangeInvestigationOutcomeInfo: function (executionContext) {
        ...
        var reconsiderationReqOption = "?$filter=_ecer_investigationid_value eq '" + recordId + "' and statecode eq 0";
        var reconsiderationRequests = crm_Utility.retrieveMultipleCustom("ecer_reconsiderationinvestigationoutcome", reconsiderationReqOption);
        var hasReconsiderationRequest = reconsiderationRequests != null && reconsiderationRequests.length > 0;
        crm_Utility.showHide(executionContext, (show && reconsiderationRequested || hasReconsiderationRequest), "tab_reconsideration");
    },
