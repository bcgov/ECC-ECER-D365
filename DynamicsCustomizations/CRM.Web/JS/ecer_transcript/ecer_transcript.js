...
ECER.Jscripts.Transcript =
{
    onLoad: function (executionContext) {
        ...
        ECER.Jscripts.Transcript.validateStartEndDate(executionContext);
    ...
    showHideEquivalencyFields: function (executionContext) {
        ...
        Xrm.WebApi.retrieveRecord("ecer_application", applicationId, options).then(
            function success(result) {
                ...
                var isICRA = typeValue === 621870004;
    ...
    // Validate that ecer_enddate is not earlier than ecer_startdate
    validateStartEndDate: function (executionContext) {
        ...
        // --- Rule 2: End Date not earlier than Start Date ---
        ...
        // --- Rule 3: Dates within 5 years of Created On ---
        // Only enforce if Created On is available (existing records)
        if (fiveYearsAgo) {
